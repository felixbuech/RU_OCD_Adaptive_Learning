classdef al_HelicopterInstructionsDefaultText
    ...
    self.context = ['In Ihrer Region ist ein lebensbedrohliches Virus ausgebrochen. Die Zahl der Infizierten steigt rasant und täglich sterben Menschen. '...
        ...
        'Da kein direkter Kontakt mit der Außenwelt mehr möglich ist, werden lebensrettende Medikamente von Helikoptern abgeworfen.\n\n '...
        ...
        'Da der Helikopter die Medikamente aus großer Höhe abwirft, kann der Landungsort nie genau vorhergesagt werden.\n\n'...
...
elseif isequal(self.language, 'English')
    ...
    self.ReminderText = ['Behalten Sie in Erinnerung: Die Zahl der Infizierten steigt immer weiter.\n\n' ...
               ...
               'Das Überleben der kranken Menschen liegt nun in Ihren Händen. Viel Erfolg!'];
...
elseif isequal(self.language, 'English')
    ...
    error('language parameter unknown')
            ...
            % Introduce cannon
            if isequal(self.language, 'German')
                self.introduceCannon = ['Sie blicken von oben auf das Gefahrengebiet und den Helikopter, der die Medikamente abwirft. Ihre Aufgabe ist es, die Medikamente mit einem Netz zu fangen. Mit dem rosafarbenen '...
    'Punkt können Sie angeben, wo auf dem Kreis Sie Ihr Netz platzieren möchten, um die Medikamente zu fangen. Sie können den Punkt mit der Maus steuern.'];
            ...
            % Introduce spot
            if isequal(self.language, 'German')
                self.introduceSpot = ['Der schwarze Strich zeigt Ihnen die mittlere Position des letzten Medikamenten-Abwurfs. Der rosafarbene Strich zeigt Ihnen die '...
            ...
            % Introduce shield
            if isequal(self.language, 'German')
                self.introduceShield = 'Nach dem Abwurf sehen Sie das Netz. Wenn Sie mindestens die Hälfte der Medikamente im Netz fangen, zählen die Medikamente als gesichert und Sie erhalten einen Punkt.';
            elseif isequal(self.language, 'English')
    ...
    'Sie das Netz genau auf dem Ziel platzieren, können Sie die Medikamente verfehlen.\n\nDie Ungenauigkeit ist zufällig, '...
    'dennoch fangen Sie die meisten Medikamente, wenn Sie den rosafarbenen Punkt genau auf die Stelle '...
    'steuern, die der Helikopter anpeilt.\n\nIn dieser Übung sollen Sie mit der Ungenauigkeit '...
    'des Helikopters erst mal vertraut werden. Steuern Sie den rosafarbenen Punkt bitte immer auf die anvisierte '...
    'Stelle.\n\nAchten Sie bitte auf Augenbewegungen und Blinzeln wie von der Versuchsleitung erklärt.'];
            ...
            if isequal(self.language, 'German') %% slighlty altered for Helicopter Version
                self.thirdPractice = ['In dieser Übung sehen Sie nur noch den Abwurf des Helikopters. '...
                    'Bitte geben Sie wieder an, wo Sie das Ziel des Helikopters vermuten.\n\nBitte beachten Sie, dass das Ziel des Helikopters meistens gleich bleibt. Manchmal richtet sich der Helikopter allerding neu aus. '...
                    'Wenn Sie denken, dass der Helikopter seine Richtung geändert hat, sollten Sie auch das Netz '...
    ...
    'Nachdem Sie – wie in den vorherigen Übungen – Ihr Netz auf dem Kreis platziert haben, wird ein Schieberegler erscheinen. Dieser Schieberegler kann zwischen 0 (sehr unsicher) und 100 (sehr sicher) bewegt werden.\n\n'...
    'Nutzen Sie den Schieberegler, um anzugeben, wie sicher Sie sich sind, dass Ihre Vorhersage zutrifft und Sie die Medikamente in Ihrem Netz fangen werden.\n\n'...
    'Diese zusätzliche Abfrage wird nur in bestimmten Blöcken des Experiments erfolgen und wird Ihnen vorher immer angesagt werden.'];
...
if isequal(self.language, 'German')
    self.introduceLowNoiseHeader = 'Genauerer Helikopter - wenig Wind';
        ...
        self.introduceLowNoiseConfidence = ['Im folgenden Block wird der Helikopter relativ genau sein.\n\n'...
            ...
            'Achten Sie bitte auf Augenbewegungen und Blinzeln wie von der Versuchsleitung erklärt.\n\n'...
            '! Zusätzlich geben Sie bitte an, wie sicher Sie sind, dass Sie die Medikamente fangen werden. Bewegen Sie dazu den Schieberegler nach jeder Vorhersage auf eine Zahl zwischen 0 (sehr unsicher) und 100 (sehr sicher).\n\n'...
