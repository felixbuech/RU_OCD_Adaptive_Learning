classdef al_commonConfidenceInstructionsDefaultText
    ...
    methods
        ...
        function self = al_commonConfidenceInstructionsDefaultText(language)
            ...
            % Fourth practice
            if isequal(self.language, 'German')
                self.fourthPractice = ['Jetzt kommen wir zur nächsten Übung.\n\nDiesmal müssen Sie mit dem rosafarbenen Punkt Ihren Eimer platzieren und sehen dabei die Kanone nicht mehr. Außerdem werden Sie es sowohl mit einer relativ genauen '...
            ...
            if isequal(self.language, 'German')
                self.ConfidencePractice = ['Jetzt kommen wir zur letzten Übung.\n\n'...
                                            ...
                                            'Nachdem Sie – wie in den vorherigen Übungen – Ihren Eimer auf dem Kreis platziert haben, wird ein Schieberegler erscheinen. Dieser Schieberegler kann zwischen 0 (sehr unsicher) und 100 (sehr sicher) bewegt werden.\n\n'...
             ...
             % Second Screen Confidence Practice Header
            ...
            if isequal(self.language, 'German')
                self.startTask = ['Sie haben die Übungsphase abgeschlossen. Kurz zusammengefasst fangen Sie also das meiste Konfetti, '...
                    ...
                    'Achten Sie bitte auf Augenbewegungen und Blinzeln wie von der Versuchsleitung erklärt.\n\n' ...
                    'In manchen Blöcken des Experiments werden Sie zudem gebeten eine Einschätzung abzugeben, wie sicher Sie sind, dass Sie das Konfetti fangen werden. '...
            ...
            if isequal(self.language, 'German')
                ...
                self.introduceLowNoiseConfidence = ['Im folgenden Block wird die Konfetti-Kanone relativ genau sein.\n\n'...
                    'Die Größe des Eimers kann sich von Durchgang '...
                    'zu Durchgang ändern. Diese Veränderung können Sie nicht beeinflussen '...
                    'und auch nicht vorhersagen. Daher ist es immer die beste Strategie, '...
                    'den Eimer genau dorthin zu stellen, wo Sie das Ziel der Konfetti-Kanone vermuten.\n\n'...
                    ...
                    'Strich zeigt die Position der letzten Konfetti-Wolke.\n\n'...
                    'Achten Sie bitte auf Augenbewegungen und Blinzeln wie von der Versuchsleitung erklärt.\n\n'...
                    '! Zusätzlich geben Sie bitte an, wie sicher Sie sind, dass Sie das Konfetti fangen werden. Bewegen Sie dazu den Schieberegler nach jeder Vorhersage auf eine Zahl zwischen 0 (sehr unsicher) und 100 (sehr sicher).\n\n'...
            ...
            if isequal(self.language, 'German')
                ...
                self.introduceHighNoise = ['Im folgenden Block wird die Konfetti-Kanone relativ ungenau sein.\n\n'...
                 ...
                 self.introduceHighNoiseConfidence = ['Im folgenden Block wird die Konfetti-Kanone relativ ungenau sein.\n\n'...
                    'Die Größe des Eimers kann sich von Durchgang '...
                    'zu Durchgang ändern. Diese Veränderung können Sie nicht beeinflussen '...
                    'und auch nicht vorhersagen. Daher ist es immer die beste Strategie, '...
                    'den Eimer genau dorthin zu stellen, wo Sie das Ziel der Konfetti-Kanone vermuten.\n\n'...
